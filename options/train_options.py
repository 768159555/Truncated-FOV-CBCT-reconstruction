...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--display_freq', type=int, default=1000, help='frequency of showing training results on screen')  # 5000
        ...
        parser.add_argument('--print_freq', type=int, default=6000, help='frequency of showing training results on console')
